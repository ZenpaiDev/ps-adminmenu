...
Config.Actions = {
        ...
        dropdown = {
            {
                ...
                data = {
                    ...
                    { label = "Light Snow",  value = "Snowlight" },
    ...
    ["change_vehicle_state"] = {
        label = "Set Vehicle State in Garage",
        perms = "mod",
        dropdown = {
            { label = "Plate",   option = "text" },
            {
    ...
    ["set_job"] = {
        ...
        dropdown = {
            ...
            { label = "Confirm", option = "button",   type = "client", event = "ps-adminmenu:client:SetJob" },
        },
    },
    ...
    ["set_gang"] = {
        ...
        dropdown = {
            ...
            { label = "Confirm", option = "button",   type = "client", event = "ps-adminmenu:client:SetGang" },
        },
    },
    ...
    ["vehicle_dev"] = {
        label = "Vehicle Development Menu",
        type = "client",
